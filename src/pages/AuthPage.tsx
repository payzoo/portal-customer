          ...
          <div className={`space-y-8 transform transition-all duration-700 ease-out ${
            ...
            {!showEmailTag ? (
              <div className="space-y-8">
                ...
                <div className="relative">
                  <div className="glass-card hover:glass-card rounded-2xl p-6 border border-border/50 backdrop-blur-sm bg-background/60 transition-all duration-300 hover:bg-background/80 hover:border-border/80">
              ...
              <div className="space-y-8 animate-fade-in">
                ...
                <div className="group cursor-pointer" onClick={handleConnection}>
                  <div className="glass-card hover:glass-card rounded-2xl p-6 border border-border/50 backdrop-blur-sm bg-background/60 transition-all duration-300 hover:bg-background/80 hover:border-foreground/30 hover:shadow-lg hover:shadow-foreground/5">
