...
import { User, Shield, Bell, HelpCircle, LogOut, ChevronRight, Globe, CheckCircle, AlertCircle, MapPin, CreditCard, Key, Smartphone, FileText, MessageCircle, Mail, Phone } from "lucide-react";
                ...
                <CardContent className="p-6 space-y-4">
                  <Button variant="outline" className="w-full justify-start h-auto p-4">
                    <div className="flex items-center gap-3 w-full">
                      ...
                      <div className="text-left">
                        ...
                        <p className="text-xs text-gray-500">FAQ et documentation</p>
                      </div>
                  ...
                  <Button variant="outline" className="w-full justify-start h-auto p-4">
                    <div className="flex items-center gap-3 w-full">
                      ...
                      <div className="text-left">
                        ...
                        <p className="text-xs text-gray-500">Support instantané 24/7</p>
                      </div>
                      <ChevronRight className="w-4 h-4 text-gray-400 ml-auto" />
                    </div>
                  </Button>
                  ...
                  <Button variant="outline" className="w-full justify-start h-auto p-4">
                    <div className="flex items-center gap-3 w-full">
                      <Mail className="w-4 h-4 text-purple-600" />
                      <div className="text-left">
                        <p className="font-medium text-gray-900 text-sm">Contacter par e-mail</p>
                  ...
                  <Button variant="outline" className="w-full justify-start h-auto p-4">
                    <div className="flex items-center gap-3 w-full">
                      ...
                      <div className="text-left">
                        ...
                        <p className="text-xs text-gray-500">Bug ou dysfonctionnement</p>
                      </div>
                      <ChevronRight className="w-4 h-4 text-gray-400 ml-auto" />
                    </div>
                  </Button>
